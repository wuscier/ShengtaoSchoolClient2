...
namespace St.Common.Commands
{
    public class GlobalCommands
    {
        ...
        public void SetCommandsStateInNonDiscussionClass(bool isMainSpeaker)
        {
            ...
            PushLiveCommand.Enabled = isMainSpeaker;
            DocCommand.Enabled = isMainSpeaker;
            AverageCommand.Enabled = true;
            BigSmallsCommand.Enabled = true;
            CloseupCommand.Enabled = true;
            InteractionCommand.Enabled = isMainSpeaker;
            SpeakerCommand.Enabled = isMainSpeaker;
            ShareCommand.Enabled = isMainSpeaker;
